...
function map(n) {
	...
	function init() {
      ...
      // Используйте инструмент Определение координат.
			controls: [],
			center: [55.720459, 53.099057],
      // Уровень масштабирования. Допустимые значения:
      // от 0 (весь мир) до 19.
			zoom: 10
		});

		let myPlacemark = new ymaps.Placemark([55.720459, 53.099057], {
		},{
			// Функции.
			//balloonContentHeader: 'VR CLUB',
			//balloonContentBody: 'Мензелинск, Изыскателей 3/13',
			//balloonContentFooter: '+ 7 (953) 488-90-03',
			//hasBalloon: true,
